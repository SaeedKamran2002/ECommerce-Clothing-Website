        ...
        <div class="row">
            ...
            <div class="col-md-9 mb-md-0 mb-5">
                ...
                <form form action="" method="post">
                    ...
                    <center><input type="submit" value="Login" class="btn btn-primary" name="login" id="login">
                        <center><br>
                            <center><a class="sss" href="adminLogin.php"
                                    style="color: blue; text-decoration: none">Login As Admin</a></center>
                            <br>
                </form>
            </div>
        </div>
